...
export const UPDATE_BRAND_KIT = 'UPDATE_BRAND_KIT';
export const DELETE_BRAND_KIT = 'DELETE_BRAND_KIT';
export const SET_ACTIVE_BRAND_KIT = 'SET_ACTIVE_BRAND_KIT';

// Brand Taste actions
export const SET_BRAND_TASTE_RATINGS = 'SET_BRAND_TASTE_RATINGS';
export const ADD_BRAND_TASTE_RATING = 'ADD_BRAND_TASTE_RATING';
export const REMOVE_BRAND_TASTE_RATING = 'REMOVE_BRAND_TASTE_RATING';
export const SET_BRAND_TASTE_PROFILE = 'SET_BRAND_TASTE_PROFILE';
